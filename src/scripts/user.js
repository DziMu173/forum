          ...
          await fetch('api/user/update', {
            ...
            .then((response) => {
              ...
              if (isUpdate.isUpdate === true) {
                message('Пароль изменен', 'success');
                event.preventDefault();
              } else {
                message('Пароль введен неверно!', 'notification');
                event.preventDefault();
              }
            });
        } else {
          message('Ошибка! Пожалуйста, проверьте правильность заполнения полей.', 'notification');
          event.preventDefault();
        }
      });
    }
